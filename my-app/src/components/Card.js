...
export default function Card(props) {
    ...
    if (time.hours < 18 && time.hours > 6) {
        if (weatherData.description === "scattered clouds" || weatherData.description === "broken clouds" || weatherData.description === "overcast clouds") image = "./images/cloudyday.jpg"
        ...
        if (weatherData.description === "scattered clouds" || weatherData.description === "broken clouds" || weatherData.description === "overcast clouds") image = "./images/night.jpg"
        else if (weatherData.description === "clear sky") image = "./images/night.jpg"
        else if (weatherData.description === "light rain") image = "./images/rainynight.png"
    }
